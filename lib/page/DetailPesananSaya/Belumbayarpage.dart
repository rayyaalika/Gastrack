// ignore_for_file: file_names, non_constant_identifier_names, depend_on_referenced_packages, camel_case_types, void_checks
...
class _MyHomePageState extends State<Belumbayarpage> {
  ...
  void getData() {
    EasyLoading.show();
    TransaksiProvider().getDatabelumbayar(SpUtil.getInt('id')).then((value) {
  ...
  InkWell cancelTransaksi(BuildContext context, int id) {
    return InkWell(
      onTap: () {
